...
def main():
    ...
    trainer = DQN_trainer(
        ...
        tau=1.0,                       # 1.0 = hard copy when soft_update_target_net runs
        tau_decay=0.0,
        ...
        buffer=buffer,
        buffer_feature=None,           # unused by ERB (only PERB needs a priority feature)
        action_dim=action_dim,
 
        epsilon=1.0,
        epsilon_min=0.05,
        epsilon_decay=0.995 / 100,     # tune against episode_num
